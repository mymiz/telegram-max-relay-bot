...
**Владелец:** Сдать номер📱 · 👤 Профиль (баланс) · код **6 цифр** · 🚫 Отказаться · 🏠 Меню

**Админ:** `/profile ID` · `/addbal ID сумма` — просмотр и пополнение баланса

**Админ:** 📋 Владельцы · 🔐 Запросить код (очередь, **1 мин** на код) · ❌ Отменить · 🏠 Меню
